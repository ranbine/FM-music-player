...
var getMusic = (function(){
	...
	// 获取频道列表
 	GetMusic.prototype.getChannels = function(){
    	var self = this;
		$.get('https://api.jirengu.com/fm/getChannels.php').done(function(channelsStr) {
	...
	// 根据得到的频道信息，获取对应随机歌曲
 	GetMusic.prototype.getAndReset = function(str) {  //参数为发送给服务器的数据，这里应该为channel的ID
 		var self = this;
	    $.get('https://api.jirengu.com/fm/getSong.php', {channel: str}).done(function(song) {
	...
	GetMusic.prototype.lyricReset = function(sidstr) {
	    var self = this;
	    $.post('https://api.jirengu.com/fm/getLyric.php', {sid: sidstr}).done(function(lyric) {
